...
function Dashboard() {
    const {totalExpenses,incomes, expenses, totalIncome, totalBalance, getIncomes, getExpenses,GetLimit,limit } = useGlobalContext()
    ...
    if (token) {
        ...
        GetLimit();
        console.log("the limit for user" ,limit)
    } else {
